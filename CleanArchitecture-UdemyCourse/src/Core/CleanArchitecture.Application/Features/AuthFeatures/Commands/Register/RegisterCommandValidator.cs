...
public class RegisterCommandValidator: AbstractValidator<RegisterCommand>
{
    public RegisterCommandValidator()
    {
        ...
        RuleFor(p => p.FullName).NotEmpty().WithMessage("Full Name adı boş olamaz!");
        RuleFor(p => p.FullName).NotNull().WithMessage("Full Name adı boş olamaz!");
        RuleFor(p => p.FullName).MinimumLength(3).WithMessage("Full Name en az 3 karakter olmalıdır!");
